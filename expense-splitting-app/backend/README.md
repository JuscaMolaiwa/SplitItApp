...
3. [Setup Instructions](#setup-instructions)
  1. [Navigate to the Backend Directory](#navigate-to-the-backend-directory)
  2. [Set Up the Virtual Environment](#set-up-the-virtual-environment)
  3. [Set Up the Database](#set-up-the-database)
  4. [Initialize and Migrate the Database](#initialize-and-migrate-the-database)
  5. [Update/Create the .env File](#updatecreate-the-env-file-at-root-of-expense-splitting-app-folder-with-your-database-credentials)
